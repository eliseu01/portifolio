...
const projects = [
  {
    ...
    description: "Comprehensive dashboard for data visualization and business intelligence with real-time analytics and automated reporting features.",
    image: "https://api.builder.io/api/v1/image/assets/TEMP/b0d6eb737e2225705c929fb0c30e3d05ea4f3c31?width=911",
  ...
  },
  {
    ...
    description: "RESTful API for e-commerce platform with payment integration, inventory management, and user authentication system.",
    image: "https://api.builder.io/api/v1/image/assets/TEMP/b0d6eb737e2225705c929fb0c30e3d05ea4f3c31?width=911",
  ...
  },
  {
    ...
    description: "ML model for sales prediction using historical data analysis with automated feature engineering and model optimization.",
    image: "https://api.builder.io/api/v1/image/assets/TEMP/b0d6eb737e2225705c929fb0c30e3d05ea4f3c31?width=911",
  ...
  },
  {
    ...
    description: "Full-stack task management application with real-time collaboration, file sharing, and project timeline tracking.",
    image: "https://api.builder.io/api/v1/image/assets/TEMP/b0d6eb737e2225705c929fb0c30e3d05ea4f3c31?width=911",
  ...
  },
  {
    ...
    description: "Personal finance management tool with expense categorization, budget planning, and financial goal tracking features.",
    image: "https://api.builder.io/api/v1/image/assets/TEMP/b0d6eb737e2225705c929fb0c30e3d05ea4f3c31?width=911",
  ...
  },
  {
    ...
    description: "Real-time IoT device monitoring system with sensor data collection, alerting, and historical data analysis.",
    image: "https://api.builder.io/api/v1/image/assets/TEMP/b0d6eb737e2225705c929fb0c30e3d05ea4f3c31?width=911",
    ...
    <div className="min-h-screen bg-background transition-colors duration-300">
        ...
        <nav className="container mx-auto px-6 py-4 flex justify-between items-center">
          ...
          <div className="hidden lg:flex items-center space-x-8 relative" ref={navRef}>
            {navItems.map((item) => (
              ...
              >
                {item.hasArrow && (
                  <ChevronRight className={`w-5 h-5 transition-all duration-300 ease-in-out ${
              ...
              <div className="space-y-12">
                ...
                <div className="space-y-6">
                  <div className="flex items-center gap-4">
                    ...
                    <h3 className="text-2xl md:text-3xl lg:text-4xl font-medium lg:font-normal">Análise de Dados</h3>
                  </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="h-1 w-64 bg-orange padding-left-8"></div>
                  <p className="text-lg md:text-xl lg:text-2xl leading-relaxed font-light lg:font-normal">
              ...
              >
                ...
                <div className="p-6 lg:p-8">
                  ...
                  <button className="group bg-orange text-white px-6 py-3 rounded-full font-poppins font-semibold text-lg flex items-center gap-2 transition-all duration-300 ease-in-out hover:bg-orange/90 hover:shadow-lg relative overflow-hidden">
                    ...
                    <span className="transition-all duration-300 ease-in-out group-hover:translate-x-1">Ver projeto</span>
                  </button>
                </div>
              </div>
            ))}
              ...
              >
                <div className="flex">
                  ...
                  <div className="flex-1 p-6">
                    ...
                    <p className="text-sm lg:text-base text-white/80 italic font-light lg:font-normal">Oracle</p>
                  </div>
                </div>
              </div>
            ))}
      ...
      <footer className={`${isDark ? 'bg-card' : 'bg-black'} text-white py-16 border-t border-border`}>
        <div className="container mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <h3 className="text-2xl md:text-3xl lg:text-5xl font-bold lg:font-extrabold">{"{eli}"}</h3>
            ...
            <div className="text-center lg:text-right">
              <h4 className="text-xl md:text-2xl lg:text-3xl font-semibold lg:font-bold mb-4">Vamos conversar?</h4>
              <p className="text-lg md:text-xl lg:text-2xl font-light lg:font-normal">eliseucoelho2006@gmail.com</p>
            </div>
          </div>
