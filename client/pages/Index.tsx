...
import { Database, Code, Menu, X, ChevronRight, Send, User, Mail, MessageSquare } from "lucide-react";
...
export default function Index() {
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Header */}
      <header className="fixed top-0 left-0 right-0 z-50 bg-gray-light/95 backdrop-blur-sm shadow-lg">
        <nav className="container mx-auto px-6 py-4 flex justify-between items-center">
          <div className="text-2xl font-bold text-black">{"{eli}"}</div>
          
          {/* Desktop Navigation */}
          <div className="hidden lg:flex items-center space-x-8">
            <button 
              onClick={() => scrollToSection('about')} 
              className="text-xl font-bold text-black hover:text-orange transition-colors flex items-center gap-2"
            >
            ...
            <button 
              ...
              className="text-xl font-bold text-black hover:text-orange transition-colors"
            >
              Competências
            </button>
            <button 
        ...
        {isMenuOpen && (
          <div className="lg:hidden bg-white border-t">
            <div className="px-6 py-4 space-y-4">
              <button 
                onClick={() => scrollToSection('about')} 
                className="block text-lg font-bold text-black hover:text-orange transition-colors"
              >
                Sobre Mim
              </button>
              <button 
        ...
        <div className="container mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <p className="text-2xl font-bold text-orange-lighter">
              ...
              <div className="flex gap-4 pt-4">
                <a 
                  ...
                  className="w-14 h-14 bg-orange rounded-full flex items-center justify-center hover:scale-105 transition-transform"
                >
            ...
            <div className="flex justify-center lg:justify-end">
              <img 
                ...
                alt="Eliseu Coelho"
                className="w-full max-w-md lg:max-w-lg xl:max-w-xl aspect-square object-cover rounded-3xl shadow-2xl"
              />
            </div>
          </div>
        </div>
      ...
      <section id="skills" className="py-20 bg-dark-section text-white">
        <div className="container mx-auto px-6">
          <h2 className="text-4xl lg:text-6xl font-bold text-center mb-16">Competências</h2>
          ...
          <div className="grid lg:grid-cols-2 gap-16 max-w-6xl mx-auto">
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-4">
                ...
                <h3 className="text-3xl lg:text-4xl font-medium">Análise de Dados</h3>
              </div>
              <div className="h-1 w-80 bg-orange"></div>
              <p className="text-xl lg:text-2xl leading-relaxed">
                Transformo dados em decisões. Trabalho com coleta, limpeza, análise e visualização de dados, extraindo 
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-4">
                ...
                <h3 className="text-3xl lg:text-4xl font-medium">Dev Back-End</h3>
              </div>
          ...
          <div className="mt-20 grid grid-cols-3 lg:grid-cols-9 gap-8 max-w-6xl mx-auto">
            {[
              ...
              <div key={index} className="w-20 h-20 lg:w-36 lg:h-36 bg-white rounded-full flex items-center justify-center hover:scale-105 transition-transform">
      ...
      <section id="projects" className="py-20 bg-white">
        <div className="container mx-auto px-6">
          <h2 className="text-4xl lg:text-6xl font-bold text-center text-black mb-16">Projetos</h2>
          
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
            {[1, 2, 3, 4, 5, 6].map((project) => (
              <div key={project} className="bg-gray-light rounded-3xl shadow-xl overflow-hidden hover:shadow-2xl transition-shadow">
                <img 
                  src="https://api.builder.io/api/v1/image/assets/TEMP/b0d6eb737e2225705c929fb0c30e3d05ea4f3c31?width=911" 
                  alt="Projeto Screenshot"
                  className="w-full h-48 lg:h-64 object-cover"
                />
                <div className="p-6 lg:p-8">
                  <h3 className="text-2xl lg:text-3xl font-bold text-black mb-4">Portfólio</h3>
                  <p className="text-lg lg:text-xl text-gray-text mb-6 leading-relaxed">
                    Atuo na interseção entre engenharia de software e análise de dados, buscando criar soluções 
                    escaláveis, eficientes e com boa experiência para o usuário.
                  </p>
                  <button className="bg-orange text-white px-6 py-3 rounded-full font-poppins font-semibold text-lg flex items-center gap-2 hover:bg-orange/90 transition-colors">
                    <ChevronRight className="w-5 h-5" />
                    Ver projeto
                  </button>
                </div>
      ...
      <section className="py-20 bg-dark-section text-white">
        <div className="container mx-auto px-6">
          <h2 className="text-4xl lg:text-6xl font-bold text-center mb-16">Certificações</h2>
          
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
            {[1, 2, 3, 4, 5, 6].map((cert) => (
              <div key={cert} className="bg-dark-section border-2 border-gray-500 rounded-3xl overflow-hidden shadow-2xl">
                <div className="flex">
                  ...
                  <div className="flex-1 p-6">
                    ...
                    <p className="text-sm lg:text-base text-white/80 italic">Oracle</p>
                  </div>
                </div>
              </div>
            ))}
      ...
      <section id="contact" className="py-20 bg-white">
        <div className="container mx-auto px-6">
          <h2 className="text-4xl lg:text-6xl font-bold text-center text-black mb-4">Contato</h2>
          <p className="text-2xl lg:text-3xl font-bold text-orange text-center mb-12">Mande-me uma mensagem!</p>
          
          <form className="max-w-4xl mx-auto space-y-8">
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                <label className="flex items-center gap-3 text-2xl lg:text-3xl font-semibold text-black mb-4">
                ...
                <input 
                  ...
                  className="w-full px-6 py-4 lg:py-6 rounded-xl bg-gray-medium text-xl lg:text-2xl placeholder-black/25 border-none outline-none focus:ring-2 focus:ring-orange"
                />
              </div>
              <div>
                <label className="flex items-center gap-3 text-2xl lg:text-3xl font-semibold text-black mb-4">
                  <Mail className="w-8 h-8 text-black/80" />
                  Seu email
                </label>
                <input 
                  type="email" 
            ...
            <div>
              <label className="flex items-center gap-3 text-2xl lg:text-3xl font-semibold text-black mb-4">
                <MessageSquare className="w-8 h-8 text-black/80" />
                Sua mensagem
              </label>
              <textarea 
                rows={6}
                ...
                className="w-full px-6 py-4 lg:py-6 rounded-xl bg-gray-medium text-xl lg:text-2xl placeholder-black/25 border-none outline-none focus:ring-2 focus:ring-orange resize-none"
              ></textarea>
            </div>
            ...
            <div className="text-center">
              <button 
                type="submit"
                className="bg-orange text-white px-12 py-4 lg:py-6 rounded-full text-2xl lg:text-3xl font-medium flex items-center gap-4 mx-auto hover:bg-orange/90 transition-colors"
              >
                Enviar mensagem
      ...
      <footer className="bg-black text-white py-16">
        <div className="container mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <h3 className="text-3xl lg:text-5xl font-bold">{"{eli}"}</h3>
              ...
              <div className="flex gap-4">
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="w-12 h-12 lg:w-16 lg:h-16 bg-orange rounded-full flex items-center justify-center hover:scale-105 transition-transform"
                >
                  <svg className="w-6 h-6 lg:w-8 lg:h-8 fill-white" viewBox="0 0 22 22">
                ...
                <a 
                  ...
                  className="w-12 h-12 lg:w-16 lg:h-16 bg-orange rounded-full flex items-center justify-center hover:scale-105 transition-transform"
                >
                  <svg className="w-6 h-6 lg:w-8 lg:h-8 fill-white" viewBox="0 0 25 21">
                ...
                <a 
                  ...
                  className="w-12 h-12 lg:w-16 lg:h-16 bg-orange rounded-full flex items-center justify-center hover:scale-105 transition-transform"
                >
                  <svg className="w-6 h-6 lg:w-8 lg:h-8 fill-white" viewBox="0 0 24 24">
            ...
            <div className="text-right">
              <h4 className="text-2xl lg:text-3xl font-semibold mb-4">Vamos conversar?</h4>
              <p className="text-xl lg:text-2xl">eliseucoelho2006@gmail.com</p>
            </div>
          </div>
